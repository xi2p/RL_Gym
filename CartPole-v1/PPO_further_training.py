...
def train():
    ...
    for iteration in tqdm.trange(1, MAX_ITER + 1, desc="Training PPO"):
        ...
        if iteration % 5 == 0:
            ...
            torch.save(agent.actor.state_dict(), "model/ppo_actor.pth")
            torch.save(agent.critic.state_dict(), "model/ppo_critic.pth")
            torch.save(agent.optimizer.state_dict(), "model/ppo_optim.pth")
