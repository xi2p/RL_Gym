...
def train():
    ...
    agent.actor.load_state_dict(torch.load("td3_actor.pth"))
    agent.target_actor.load_state_dict(torch.load("td3_target_actor.pth"))

    agent.critic_1.load_state_dict(torch.load("td3_critic_1.pth"))
    agent.critic_2.load_state_dict(torch.load("td3_critic_2.pth"))
    agent.target_critic_1.load_state_dict(torch.load( "td3_target_critic_1.pth"))
    agent.target_critic_2.load_state_dict(torch.load("td3_target_critic_2.pth"))

    agent.critic_1_optimizer.load_state_dict(torch.load("td3_critic_1_optim.pth"))
    agent.critic_2_optimizer.load_state_dict(torch.load("td3_critic_2_optim.pth"))
    agent.actor_optimizer.load_state_dict(torch.load("td3_actor_optim.pth"))
